    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('galaxy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='zooniverse_web.Galaxy')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='zooniverse_web.ImageStore')),
            ],
        ),
        migrations.CreateModel(
            name='QuestionOption',
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='zooniverse_web.Question')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='zooniverse_web.Survey')),
                ('survey_element', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='zooniverse_web.SurveyElement')),
            ],
        ),
        migrations.CreateModel(
            name='Verification',
        ...
        migrations.AddField(
            model_name='response',
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='zooniverse_web.Survey'),
        ),
        migrations.AddField(
            model_name='response',
            name='user',
        ...
        migrations.AddField(
            ...
            name='response',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='zooniverse_web.Response'),
        ),
        migrations.AddField(
            model_name='questionresponse',
            name='survey_question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='zooniverse_web.SurveyQuestion'),
        ),
        migrations.AddField(
