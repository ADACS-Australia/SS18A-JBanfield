...
def add_question_and_options(apps, schema_editor):
    from zooniverse_web.models import Question, QuestionOption
...
def upload_data(apps, schema_editor):
    ...
    galaxies = read_csv(settings.BASE_DIR + '/../zooniverse_web/static/fri_frii_background_features.csv')
